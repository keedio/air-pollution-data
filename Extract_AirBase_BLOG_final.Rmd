...
To extract the rawdata for the previous selection per country, a function called _extract_CT_data_ extracts a country's rawdata based on the selected components and sample periods. This function is incorporated in the  _**AirBase_CT_data.R**_ script.
...
<iframe src="dygraph_blog.html"style="border: none; width: 940px; height: 600px"></iframe>
...
Then, with the previous information, we chop/slice/trim the extracted datasets. A function called _chop_fill_data_ does this and fills NA values in the data (or not, the option is given). As before, this function is incorporated in the  _**AirBase_CT_data.R**_  script.
...
<iframe src="map_blog.html"style="border: none; width: 940px; height: 600px"></iframe>
